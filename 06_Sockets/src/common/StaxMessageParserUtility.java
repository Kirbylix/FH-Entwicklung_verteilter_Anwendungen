...
public class StaxMessageParserUtility 
{
    ...
    public boolean isKnownStartElement(String name) throws ParserException
    {
    ...
    public String getStartElement() throws ParserException
    {
    ...
    public void skipKnownStartElement(String name) throws ParserException
    {
    ...
    public String getCharacters() throws ParserException
    {
        String value = null;
    ...
    public String getKnownLeafElement(String elementName) throws ParserException
    {
    ...
    public boolean skipKnownEndElement(String name) throws ParserException
    {
	...
	public boolean isKnownEndElement(String name) throws ParserException
	{
